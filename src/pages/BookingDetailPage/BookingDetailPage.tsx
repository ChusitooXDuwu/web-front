...
const BookingDetailPage: FC<BookingDetailPageProps> = () => {
  ...
  const priceToShow = isSplit
    ? (price / mockEvent.currentPlayers).toFixed(2)
    : price;
      ...
      >
        ...
        <Row className="justify-content-center my-5">
          <Col className="text-center">
            ...
            <p className="mt-3">
              <FormattedMessage
                id="bookingDetailPage.loading.details"
                defaultMessage="Cargando detalles de la reserva..."
              />
            </p>
          </Col>
        </Row>
        ...
        <Row className="justify-content-center my-4">
          <Col md={8}>
            <Alert variant="danger">
              <Alert.Heading>
                <FormattedMessage
                  id="bookingDetailPage.error.title"
        ...
        <Row className="justify-content-center my-4">
          <Col md={8}>
            <Alert variant="warning">
              <Alert.Heading>
                <FormattedMessage
                  id="bookingDetailPage.notFound.title"
              ...
              <div className="d-flex justify-content-between">
                <Link to="/bookings" className="btn btn-outline-primary">
                  <FormattedMessage
                    id="bookingDetailPage.backToBookings"
                    defaultMessage="Volver a mis reservas"
                  />
                </Link>
              </div>
            </Alert>
      ...
      <Row className="px-4">
        ...
        >
          ...
          <div className={styles.imageWrapper}>
            <img
              src="https://ccce.org.co/wp-content/uploads/2019/09/consejo-ccce-payu.jpg"
              alt="Pago PayU"
              className={styles.priceImage}
              onClick={(e) => handlePayment((e.target as HTMLImageElement).alt)}
            />
            <img
              src="https://d31dn7nfpuwjnm.cloudfront.net/images/valoraciones/0039/6155/Qu%C3%A9_es_Nequi_y_c%C3%B3mo_funciona.jpg?1598852798"
              alt="Pago Nequi"
              className={styles.priceImage}
              onClick={(e) => handlePayment((e.target as HTMLImageElement).alt)}
            />
            ...
            />
            <img
              src="https://play-lh.googleusercontent.com/fIwuxVTuoLOzhrKJL6GCGIKuEJc6JFu9Ii97cp0nFWE61qpfeaIhFBiNL5wFcydvhQA"
              alt="Pago DaviPlata"
              className={styles.priceImage}
              onClick={(e) => handlePayment((e.target as HTMLImageElement).alt)}
            />
          ...
          <div className={styles.imageWrapper}>
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSlhi5rxI9Fcyi4s0Y-nZM3FFvDX1asdLYOgA&s"
              alt="Mercado Pago"
              className={styles.priceImage}
              onClick={(e) => handlePayment((e.target as HTMLImageElement).alt)}
            />
            ...
            />
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0cWaCbny3YjfPiMmFHZkwXpf-8nUrnqIU2w&s"
              alt="Mastercard"
              className={styles.priceImage}
              onClick={(e) => handlePayment((e.target as HTMLImageElement).alt)}
            />
            <img
              src="https://bulevar.com.co/wp-content/uploads/2023/07/bancolombia.jpg"
              alt="Bancolombia"
              className={styles.priceImage}
              onClick={(e) => handlePayment((e.target as HTMLImageElement).alt)}
            />
