    ...
    >
      ...
      <Row className="px-4">
        ...
        <Col className={`${styles.priceColumn} d-flex flex-column align-items-center justify-content-center px-4`}>
          ...
          <h3 className={styles.priceText}><FormattedMessage id="fieldDetailPage.price" defaultMessage="Precio: $"/>{priceToShow}</h3>
          <h3 className={styles.selectText}><FormattedMessage id="fieldDetailPage.payment" defaultMessage="Selecciona cómo deseas pagar"/></h3>
