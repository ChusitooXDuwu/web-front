...
function Match(props: { fecha: Date, start_time: Date, end_time: Date, current_players: number, max_players: number, deporte: string, image: string }) {
    ...
    const renderCupos = () => {
        return cupos === 0 ? "¡Sé el primero en inscribirte!" : `Cupos: ${cupos}/${props.max_players}`;
    };

    const handleCupos = () => {
        if (cupos < props.max_players) {
            setCupos(cupos + 1);
                ...
                <Row className="g-0 flex-column flex-sm-row h-100">
                    ...
                    >
                        <Card.Body className="d-flex flex-column justify-content-between flex-grow-1">
                            <div>
                                <Card.Title className="text-warning fs-5">{props.deporte}</Card.Title>
                                <Card.Text className="fs-6">
                                    ...
                                    <div className="d-flex align-items-center mb-2">
                                        ...
                                        />
                                        <p className="mb-0">
                                            <strong>Fecha:</strong> {props.fecha.toDateString()}
                                        </p>
                                    </div>
                                    ...
                                    <div className="d-flex align-items-center mb-2">
                                        ...
                                        />
                                        <p className="mb-0">
                                            <strong>Hora:</strong> {props.start_time.toLocaleTimeString()} - {props.end_time.toLocaleTimeString()}
                                        </p>
                                    </div>
